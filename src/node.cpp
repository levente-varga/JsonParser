...
std::shared_ptr<Json::Node> Json::Node::operator[](const unsigned int index)
{
    if (std::holds_alternative<List>(value))
    {
        ...
        throw Exception("Requested vector-like indexing on " + getTypeAsString() + " type JSON node");
}
...
std::shared_ptr<Json::Node> Json::Node::operator[](const char *key)
{
    if (std::holds_alternative<Object>(value))
    {
        ...
        throw Exception("Requested map-like indexing on " + getTypeAsString() + " type JSON node");
}
...
Json::Node::operator bool() const
{
    if (std::holds_alternative<bool>(value))
    {
        ...
        throw Exception("Cannot convert " + getTypeAsString() + " node to bool");
}
...
Json::Node::operator int() const
{
    ...
    else if (std::holds_alternative<double>(value))
    {
        ...
        throw Exception("Cannot convert " + getTypeAsString() + " node to int");
}
...
Json::Node::operator double() const
{
    ...
    else if (std::holds_alternative<int>(value))
    {
        ...
        throw Exception("Cannot convert " + getTypeAsString() + " node to double");
}
...
Json::Node::operator std::string() const
{
    if (std::holds_alternative<std::string>(value))
    {
        ...
        throw Exception("Cannot convert " + getTypeAsString() + " node to std::string");
}

Json::Node::operator List() const
{
    if (std::holds_alternative<List>(value))
    {
        ...
        throw Exception("Cannot convert " + getTypeAsString() + " node to std::vector");
}

Json::Node::operator Object() const
{
    if (std::holds_alternative<Object>(value))
    {
        ...
        throw Exception("Cannot convert " + getTypeAsString() + " node to std::map");
}
...
void Json::Node::addChild(std::pair<std::string, std::shared_ptr<Node>> child)
{
    if (std::holds_alternative<Object>(value))
    {
        ...
        throw Exception("Requested map-like insert on " + getTypeAsString() + " type node");
}
...
void Json::Node::addChild(std::shared_ptr<Node> child)
{
    if (std::holds_alternative<List>(value))
    {
        ...
        throw Exception("Requested list-like insert on " + getTypeAsString() + " type node");
}
